...
@Component({
  selector: 'app-student-registered',
  templateUrl: './student-registered.component.html',
  styleUrls: ['./student-registered.component.scss']
})
...
export class StudentRegisteredComponent implements OnInit {
  tableData = [
    {
      learnerId: '24578164',
      learnerName: 'Bessie Cooper',
      program: 'GKH Karat',
      location: 'Pune',
      className: 'Karate Class',
      status:'',
      previousLevel: 'L1-White Belt',
      newLevel: 'L2-Blue Belt',
      certificateIssued: '15-01-24'
    },
    {
      learnerId: '24578164',
      learnerName: 'Annette Black',
      program: 'GKH Karat',
      location: 'Pune',
      className: 'Karate Class',
      status: '',
